...
TICKERS = [
    ...
    "7030.T",#  02 スプリックス
    "4923.T",#  03 コタ
    "9432.T",#  04 日本電信電話（NTT）
    "9904.T",#  05 ベリテ
    "9997.T",#  06 ベルーナ
    "6539.T",#  07 MS-Japan
    "3465.T",#  08 ケイアイスター不動産
    "6523.T",#  09 PHCホールディングス
    "7414.T",#  10 小野建
    "7638.T",#  11 NEW ART HOLDINGS
    "7203.T",#  12 トヨタ自動車
    "1898.T",#  13 世紀東急工業
    "3131.T",#  14 シンデン・ハイテックス
    "1820.T",#  15 西松建設
    "3284.T",#  16 フージャースホールディングス
    "6419.T",#  17 マースグループホールディングス
    "4671.T",#  18 ファルコホールディングス
    "3548.T",#  19 バロックジャパンリミテッド
    "8897.T" #  20 MIRARTHホールディングス
